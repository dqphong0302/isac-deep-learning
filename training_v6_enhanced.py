#!/usr/bin/env python3
"""
training_v6_enhanced.py
V6: Enhanced Feature Engineering

Features: 274 (210 base + 64 enhanced)
- Phase difference histogram (32)
- Time-domain statistics (8)
- Pilot response statistics (16)
- Cross-correlation features (8)
"""
...
class EnhancedMLP(nn.Module):
    def __init__(self, in_dim=274, width=512, depth=4, dropout=0.2):
        super().__init__()
        layers = []
        d = in_dim
...
def main():
    ...
    parser.add_argument("--h5", default="dataset_v6_enhanced.h5")
    ...
    parser.add_argument("--ckpt", default="best_v6_enhanced.pt")
    ...
    model = EnhancedMLP(in_dim=in_dim, width=args.width, depth=args.depth, dropout=args.dropout).to(device)
    n_params = sum(p.numel() for p in model.parameters() if p.requires_grad)
    print(f"Model: EnhancedMLP, {n_params:,} params")
    ...
    print("\n" + "="*60)
    print("Training V6: Enhanced Feature Engineering")
    print("="*60 + "\n")
